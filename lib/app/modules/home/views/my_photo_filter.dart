...
import '../../../helper_widgets/scanner_widget.dart';
                    ...
                    onPressed: () async {
                      ...
                      if (await Permission.storage.request().isGranted) {
                        final result = await SaverGallery.saveImage(
                            ...
                            androidRelativePath:
                                "Pictures/BestImageEditor/images");
                        ...
                        print("Saved image to: ${imageFile.path}");
                        print("Saved image to Gallery: ${result}");
                      } else {
                        await Permission.storage.request();
                        // await SaverGallery.saveImage(imageFile);
                      }
